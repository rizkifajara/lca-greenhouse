...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url();?>assets/dist/img/lcamaster.png" alt="AdminLTELogo" height="120" width="120">
  </div>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" width ="25px" height="25px"
                                    src="<?php echo base_url('assets/dist/img/'). $user['image'];?>">
                            </a>

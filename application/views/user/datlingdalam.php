          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header text-right">
                <h3 class="card-title">Tabel Data Lingkungan Dalam</h3>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td style = text-align:center>
                    <!-- <a href="<?= base_url('datlingdalam/detail/'.$tbl->id)?>" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a> -->
                    <a href="<?= base_url('datlingdalam/edit/'.$tbl->id)?>"  class="mr-3" title="Edit Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>
                    <a href="<?= base_url('datlingdalam/hapus/'.$tbl->id)?>" onclick="javascript: return confirm('Apakah anda yakin ingin menghapus data?')" class ="mr-auto title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span> </a>
                  </td>
                  </tr>
                  <?php
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method ="post" action="<?php echo base_url().'datlingdalam/tambah_aksi';?>">
